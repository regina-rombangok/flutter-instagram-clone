...
class Repository {
  ...
  Future<void> addPostToDb(User1 currentUser, String imgUrl, String caption, String location) => _firebaseProvider.addPostToDb(currentUser, imgUrl, caption, location);
  
  Future<User1> retrieveUserDetails(User user) => _firebaseProvider.retrieveUserDetails(user);
  ...
  Future<User1> fetchUserDetailsById(String uid) => _firebaseProvider.fetchUserDetailsById(uid);
  ...
  Future<List<User1>> fetchAllUsers(User user) => _firebaseProvider.fetchAllUsers(user);
